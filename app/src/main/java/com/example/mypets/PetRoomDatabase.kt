...
@Database(entities = [Pet::class], version = 12)
        ...
        override fun onOpen(db: SupportSQLiteDatabase) {
            ...
            INSTANCE?.let { database ->
                scope.launch(Dispatchers.IO) {
                    ...
                    //Insert pet
                    val pet1 = Pet(name = "Berry", breed = "Chihuahua", weight = 25, gender = "Male")
                    petDao.insert(pet1)
                    val pet2 = Pet(name = "Cockie", breed = "German Shepherd", weight = 10, gender = "Female")
                    petDao.insert(pet2)
